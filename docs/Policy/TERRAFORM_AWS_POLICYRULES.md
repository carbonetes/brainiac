...
| CB_TFAWS_359 | Resource | aws_elasticsearch_domain | Verify ElasticSearch/OpenSearch has dedicated master node enabled | checker/terraform/rules/aws/verify_elasticsearch_opensearch_didicated_master_node_enabled.rego |
| CB_TFAWS_359 | Resource | aws_opensearch_domain | Verify ElasticSearch/OpenSearch has dedicated master node enabled | checker/terraform/rules/aws/verify_elasticsearch_opensearch_didicated_master_node_enabled.rego |
