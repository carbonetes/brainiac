...
# description: "Exposing port 22 to all IP addresses (0.0.0.0/0) on your AWS resources poses a security risk, as it facilitates potential unauthorized access and increases vulnerability to external threats."
# scope: package
# related_resources:
