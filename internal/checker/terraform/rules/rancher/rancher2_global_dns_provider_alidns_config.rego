# METADATA
# title: "Verify AliDNS Domain for Rancher2 Global DNS Provider"
# description: "Policy to verify that the Rancher2 Global DNS Provider configuration includes AliDNS Domain."
# scope: package
# related_resources:
...
passed[result] {
	some block in pass
	result := {
		"message": "All Rancher2 Global DNS Provider configurations include AliDNS Domain.",
		"snippet": block,
	}
}
...
failed[result] {
	some block in fail
	result := {
		"message": "Some Rancher2 Global DNS Provider configurations are missing AliDNS Domain. Please ensure AliDNS Domain are provided.",
		"snippet": block,
	}
}