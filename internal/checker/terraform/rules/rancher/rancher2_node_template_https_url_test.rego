...
test_rancher2_node_template_https_url_passed {
...
test_rancher2_node_template_https_url_failed {
	result := failed with input as [{
        ...
        "Attributes": {
            "cloud_credential_id": "rancher2_cloud_credential.foo-harvester.id",
            "engine_install_url": "http://releases.rancher.com/install-docker/20.10.sh",
            "name": "foo-harvester"
        },
        "Blocks": [
            {
