...
passed[result] {
	some block in pass
	result := {
		"message": "Security context is appropriately applied to pods, deployments, and daemon sets, contributing to a secure Kubernetes environment.",
		"snippet": block,
	}
}
...
failed[result] {
	some block in fail
	result := {
		"message": "Security context is not adequately applied to pods, deployments, and daemon sets, potentially exposing security vulnerabilities. Apply relevant security context settings to enhance the security of containerized workloads.",
		"snippet": block,
	}
}
