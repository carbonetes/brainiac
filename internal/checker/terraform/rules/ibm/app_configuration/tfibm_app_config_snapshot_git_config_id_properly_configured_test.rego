...
test_tfibm_app_config_snapshot_git_config_id_properly_configured_passed if {
	result := passed with input as [
    {
        ...
        "Attributes": {
            ...
            "git_file_path": "path/to/config_file.json",
            "git_token": "git_token",
...
test_tfibm_app_config_snapshot_git_config_id_properly_configured_failed if {
