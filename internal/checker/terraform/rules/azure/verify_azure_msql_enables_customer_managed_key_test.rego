...
test_azure_msql_enables_customer_managed_key_passed {
    ...
    },
    {
        ...
        "Attributes": {
            ...
            "object_id": "azurerm_mysql_server.ok.identity..principal_id",
            "secret_permissions": [
                "get"
            ],
            "tenant_id": "data.azurerm_client_config.current.tenant_id"
...
test_azure_msql_enables_customer_managed_key_failed {
