# METADATA
# title: "Verify that the --peer-cert-file and --key-file arguments are set properly"
# description: "Ensure that the --peer-cert-file and --key-file arguments are set properly"
# scope: package
# related_resources:
...
default flag_0 := "--peer-cert-file"
default flag_1 := "--peer-key-file"
