# METADATA
# title: "Verify that the API Server only use Strong Cryptographic Ciphers"
# description: "By verifying that the API Server only uses strong cryptographic ciphers, Kubernetes ensures that communication between components, such as clients and the API Server, is adequately protected from potential security threats. "
# scope: package
# related_resources:
...
#   id: CB_K8S_095
#   severity: HIGH
package lib.kubernetes.CB_K8S_095
